...
func (b *ResourceQuotaApplyConfiguration) Original() client.Object {
	return &apicorev1.ResourceQuota{}
}

func (b *ResourceQuotaApplyConfiguration) Extract(obj client.Object, fieldManager string, subresource string) (*ResourceQuotaApplyConfiguration, error) {
	return extractResourceQuota(obj.(*apicorev1.ResourceQuota), fieldManager, subresource)
}
func (b *ResourceQuotaApplyConfiguration) ObjectKey() (client.ObjectKey, error) {
	if b.Namespace == nil {
		return client.ObjectKey{}, errors.New("The ResourceQuotaApplyConfiguration namespace should not be empty.")
	}
	if b.Name == nil {
		return client.ObjectKey{}, errors.New("The ResourceQuotaApplyConfiguration name should not be empty.")
	}
