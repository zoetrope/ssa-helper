...
func (in *RuntimeClassApplyConfiguration) DeepCopyInto(out *RuntimeClassApplyConfiguration) {
	*out = *in
	...
	if in.Spec != nil {
		...
		*out = new(RuntimeClassSpecApplyConfiguration)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuntimeClassSpecApplyConfiguration) DeepCopyInto(out *RuntimeClassSpecApplyConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuntimeClassSpecApplyConfiguration.
func (in *RuntimeClassSpecApplyConfiguration) DeepCopy() *RuntimeClassSpecApplyConfiguration {
	if in == nil {
		return nil
	}
	out := new(RuntimeClassSpecApplyConfiguration)
...
func (in *SchedulingApplyConfiguration) DeepCopyInto(out *SchedulingApplyConfiguration) {
	*out = *in
	...
	if in.Tolerations != nil {
		...
		*out = make([]corev1.TolerationApplyConfiguration, len(*in))
		for i := range *in {
