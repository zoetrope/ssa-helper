...
func (b *CSIDriverApplyConfiguration) Original() client.Object {
	return &apistoragev1.CSIDriver{}
}

func (b *CSIDriverApplyConfiguration) Extract(obj client.Object, fieldManager string, subresource string) (*CSIDriverApplyConfiguration, error) {
	return extractCSIDriver(obj.(*apistoragev1.CSIDriver), fieldManager, subresource)
}
func (b *CSIDriverApplyConfiguration) ObjectKey() (client.ObjectKey, error) {
	if b.Name == nil {
		return client.ObjectKey{}, errors.New("The CSIDriverApplyConfiguration name should not be empty.")
	}
